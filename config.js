...
(function(){
  ...
  function boot(){
    ...
    load('sidebar-operasional-fix-v70.4.5.js?v=3','data-barokah-sidebar-operasional-fix');
    load('sidebar-operasional-route-fix-v70.4.8.js?v=2','data-barokah-operational-route-fix-v7048');
