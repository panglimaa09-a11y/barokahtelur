(function(){
  ...
  async function printNota(id){
    ...
    // Buka jendela cetak SEGERA saat user menekan tombol.
    // Ini menjaga user gesture pada browser mobile sehingga tidak perlu klik 2x.
    let w=null;
    ...
    try{
      ...
      // Data sudah diambil langsung dari Supabase, lalu isi window yang sudah dibuka.
      w.document.open();
